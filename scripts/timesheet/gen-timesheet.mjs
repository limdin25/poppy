// Rebuilds /timesheet for Pedro, week of 17 to 21 August 2026.
...
const STYLE = fs.readFileSync(path.join(HERE, 'old-style.css'), 'utf8');

const THIS_WEEK = ['2026-08-17', '2026-08-21'];
const LAST_WEEK = ['2026-08-10', '2026-08-14'];
const RATE = 2.5;
const EXTRA_BREAK_H = 3; // Hugo asked Pedro to stop for work several times; paid regardless.

const NOTES = { '2026-08-10': 8, '2026-08-11': 16, '2026-08-12': 7, '2026-08-13': 8, '2026-08-14': 10,
                '2026-08-17': 8, '2026-08-18': 29, '2026-08-19': 27, '2026-08-20': 10, '2026-08-21': 4 };
const TEXTS = { '2026-08-14': 8, '2026-08-17': 11, '2026-08-18': 33, '2026-08-19': 2, '2026-08-20': 3, '2026-08-21': 2 };
const UNIQUE = { last: { dialled: 295, spoken: 186 }, this: { dialled: 212, spoken: 145 } };
...
const DAY_NOTES = {
  ...
  '2026-08-21': [
    ...
    { fair: true, text: 'Both viewings of the week were booked on those 14 calls. Low volume, but it converted.' },
  ],
};
...
<title>Pedro Almedina, timesheet for 17 to 21 August 2026</title>
${STYLE.replace('</style>', `
...
<div class="wrap">
  ...
  <header class="masthead">
    <div class="who">
      ...
      <div class="sub">Monday 17 August to Friday 21 August 2026</div>
    </div>
    <div class="headline">
      ...
      <div class="hstat"><div class="eyebrow">Days worked</div><div class="val">${daysWorked} of 5</div><div class="foot">Every day of the week</div></div>
  ...
  <section>
    <div class="sechead">
      ...
      <p>Monday 10 to Friday 14 August against Monday 17 to Friday 21 August. Same rules, same log, same person reading it.</p>
    </div>
    <div class="panel">
      <div class="tscroll">
        <table>
          <thead><tr><th>What</th><th>10 to 14 Aug</th><th>17 to 21 Aug</th><th>Change</th></tr></thead>
          <tbody>
            ${cmpRows}
          </tbody>
        </table>
    ...
    <div class="panel">
      ...
      <div class="tscroll">
        <table>
          <thead><tr><th>Outcome</th><th>10 to 14 Aug</th><th>17 to 21 Aug</th><th>Change</th></tr></thead>
          <tbody>
            ${outRows}
          </tbody>
        </table>
    ...
    <div class="panel flat">
      ...
      <p>The weak spots are Wednesday and Friday. Wednesday had ten separate stops over 10 minutes. Friday had 14 calls and stopped at 11:52. Tuesday shows what a full day looks like: 8h 36m of working time with 46 minutes of stops.</p>
    </div>
  </section>
...
${dayCards}
  ...
  <section>
    ...
    <div class="panel">
      <p>A full week is 5 days at 8 hours, which is 40 hours for $100. That makes the rate <strong>$${RATE.toFixed(2)} an hour</strong>. You are paid for every hour worked, plus your 1 hour break on each day, plus the 3 hours of stops we asked you to take.</p>
      <div class="maths">
        <div class="mrow"><span class="lbl">Hours available in the week</span><span>40h 00m</span></div>
    ...
    <div class="panel flat">
      ...
      <p>Last week you were paid 28.19 hours, which was $70.48. This week is ${paidHours.toFixed(2)} hours, which is $${due}.00. Almost the same money for a week where you talked to people for three hours longer. The difference is Friday. It paid ${hm(rows[4].paid)}, which is about 6 hours short of a full day, and that single morning is most of the gap.</p>
    </div>
  </section>
  ...
  <footer>
    <div>Prepared from the call system on 22 August 2026. Source: ${B.calls} call records, ${B.notes} call notes and ${B.texts} messages, timed to the second, Europe/London. Saturday 22 August is still in progress and falls in next week's timesheet.</div>
