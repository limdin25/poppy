...
> I'm not going to take any more of your time — that's genuinely it, I just want you to have it. If you tell me you'll watch it, I'll text it to this number right now. Is that alright?

- Giving the time back is what disarms them.
- This is the **only** close on this call, and it's a yes to *watching*, not to buying.

## 5 · Send it while they're on the line

> Perfect — is this number the best one for a text? … Sending it over now, you'll have it in a few seconds. Has it come through?

- Read the number back and wait for the yes.
- Tap **Video → Text the video** in the dialer *while they're still on the phone*.
- Stay on until they confirm it landed. A link they never got is a wasted call.

## 6 · Get off the phone

> Great. It's 90 seconds — watch it tonight when you've got a minute. Everything's on that page, and if it makes sense you can start it yourself from there for a quid. I'll let you get back to it — cheers.
...
4. Permission — give the time back: "I'm not going to take any more of your time, that's genuinely it. If you tell me you'll watch it, I'll text it to this number now. Is that alright?" This is the ONLY close on the call, and it is a yes to WATCHING, not to buying.
5. Sent — confirm the mobile, send the link while they are still on the line, and stay on until they confirm it arrived.
