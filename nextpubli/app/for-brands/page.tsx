        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-6 max-w-lg text-lg leading-relaxed text-white/60">
              Publish content directly to the feed and stories of thousands of creators.
              Pay only for results, commission on real sales.
            </p>

            <ul className="mt-8 space-y-4">
              {[
                "Access to 2,500+ verified creators in Brazil",
                "Automatic publishing via API, no waiting on the creator",
                "Performance-based payment: up to 50% commission per sale",
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
            {success ? (
              ...
              <>
                <h2 className="text-xl font-bold text-white">Talk to our team</h2>
          ...
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            ...
            <div className="flex items-center gap-6">
              <span className="text-sm text-white/40">
                Contact: {landingCopy.footer.emails.brands}
              </span>
            </div>
            <div className="flex items-center gap-4">
              <a
