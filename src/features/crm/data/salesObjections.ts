...
export const SALES_OBJECTIONS: Objection[] = [
  ...
  { group: 'Objections', q: `"I never buy over the phone"`, a: `"That's the thing, you're not giving me anything over the phone. I text you a link, you sign up yourself on your own phone and pop the card in on a secure Stripe page, I never see it. Nothing comes off it for 10 days. Fair enough?"` },
