      ...
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
        ...
        <div className="mt-8 space-y-8 text-[15px] leading-relaxed text-gray-700">
          ...
          <section>
            ...
            <ul className="mt-2 list-disc pl-6 space-y-1">
              <li><strong>Activation credit:</strong> A one-time payment of {'\u00a3'}5/$5/{'\u20ac'}5 is required to activate your account. This is applied as a credit toward your first invoice.</li>
