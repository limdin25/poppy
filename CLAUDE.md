...
- **Houses for Pedro — the human path (2026-08-09)**, see Claude memory `project_houses_pedro`:
  ...
  - **Training: `heyelsie.com/pedro-training` (PIN 1176) and `heyelsie.com/hugo-training` (PIN 8642)** — see Claude memory `project_pedro_training`. Both noindex + robots Disallow and **not to be shared**.
