...
test.describe("scheduler: only connected influencers", () => {
  const connectedEmail = "e2e-scheduler-conn@heypubli-e2e.test";
  const unconnectedEmail = "e2e-scheduler-noconn@heypubli-e2e.test";
...
test.describe("suspended influencer lockout", () => {
  const email = "e2e-suspended@heypubli-e2e.test";
