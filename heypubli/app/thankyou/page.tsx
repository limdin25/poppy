      ...
      <div className="flex-1 flex items-center justify-center px-6 py-16">
        <div className="max-w-md w-full text-center">
          ...
          <p className="text-lg text-gray-500 mb-10">
            Your ScanPlates access is ready. Follow the steps below to get started.
          </p>
          ...
          <div className="border border-gray-200 rounded-2xl p-8 text-left mb-10">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-semibold">Sign in with your email</p>
                  <p className="text-gray-500 text-sm mt-1">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm mt-1">
                    Take a photo of your plate and see the calories in seconds
                  </p>
                </div>
              </div>
            </div>
