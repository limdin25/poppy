...
| 18 | Reuse existing Retell agent + SIP trunk (not rebuild from scratch) | Hugo already had Retell agent, LLM, SIP trunk, and imported phone number configured. Updated the LLM prompt to Poppy's format and pointed webhook to our endpoint instead of n8n. | 2026-05-03 |
