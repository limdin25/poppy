...
VALUES (
  ...
  'Welcome to the team! We are really glad to have you as a B2B Sales Closer at HeyElsie. This is a short, plain English agreement so you know exactly how we work together and how you get paid. You can ask us anything before you sign.',
  'HeyElsie',
  '[
    ...
    {"heading":"Your hours","body":"Monday to Friday, 10:00am to 6:00pm UK time (6:00pm to 2:00am in the Philippines), with a 1 hour break. After a successful two week trial, we may move you to an 8:00am to 4:00pm UK shift."},
    {"heading":"Your pay","body":"You start on 100 USD per week (400 USD per month). Every client you close permanently adds 25 USD to your weekly base, up to a maximum of 200 USD per week (800 USD per month). On top of your weekly salary, you also earn 50% commission on each client''s first month payment. Your commission is paid within 7 days of that client''s first payment clearing."},
    ...
    {"heading":"Breaks and staying on the calls","body":"Short breaks are fine and sometimes needed. You must always tell your manager when you go on a break, and tell them again as soon as you are back. Going quiet for more than 10 minutes without telling anyone counts as a strike. Three strikes and we may end your role immediately, with no notice. This keeps things fair for the whole team."},
