...
export default async function handler(req: Request): Promise<Response> {
  ...
  try {
    ...
    <div style="font-family:sans-serif;line-height:1.6;color:#1c1c28;max-width:520px;margin:0 auto;">
      ...
      <p>${name ? `Hi ${name.split(/\s+/)[0]}, ` : ''}${biz?.name || 'A fellow business owner'} uses HeyElsie Reviews to turn happy customers into Google reviews automatically — and referred you.</p>
